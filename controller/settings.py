...
SECRET_KEY = "django-insecure-(^b#9@^6k_)pt)z38lce3p^=p2t(2()$-nna35yf^1($sdn&mw"
...
]  # Allow CSRF for Codespaces and localhost
...
INSTALLED_APPS = [
    ...
    "todolist", # Your app for managing to-do items
]
